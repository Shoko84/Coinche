...
namespace Client
{
    ...
    public class NetworkManager
    {
        ...
        private void Init()
        {
            ...
            SetCallBackFunction<string>("041", GameInfos.Instance.EventManager.PlayerHasLost);
            SetCallBackFunction<string>("042", GameInfos.Instance.EventManager.PlayerHasWon);
